...
- Authors: Daron Acemoglu; Weihao Kong; Asuman Ozdaglar
- Version formalized: May 5, 2026
- Official URL: https://economics.mit.edu/people/faculty/daron-acemoglu/research
- Public PDF: https://economics.mit.edu/sites/default/files/2026-05/AI%2C%20Human%20Cognition%20and%20Knowledge%20Collapse%2005-05-26.pdf
...
- Implementation theorem file: `AKO26KnowledgeCollapse/MainTheorems.lean`
- Human-facing theorem file: `AKO26KnowledgeCollapse/PaperInterface.lean`
- Machine-readable status source: `AKO26KnowledgeCollapse/status.json`
- Private outside-Lean proof plan: `AKO26KnowledgeCollapse/docs/FORMALIZATION_PLAN.md`
- Final validation report: `AKO26KnowledgeCollapse/FINAL_VALIDATION_REPORT.md`
- Dependency DAG: `AKO26KnowledgeCollapse/docs/DependencyDAG.tex`
- Rendered DAG: `AKO26KnowledgeCollapse/docs/DependencyDAG.pdf`
- LLM/source audit sidecars: `AKO26KnowledgeCollapse/audit/*.json`
...
`python3 scripts/review_dashboard.py --paper AKO26KnowledgeCollapse --statement-precheck`.
...
Then run `python3 scripts/review_dashboard.py --paper AKO26KnowledgeCollapse
...
`python3 scripts/review_dashboard.py --paper AKO26KnowledgeCollapse --precheck` only to
...
`python3 scripts/closeout_reuse_plan.py --paper AKO26KnowledgeCollapse` and execute only its
current `next_action`.
...
`python3 scripts/review_dashboard.py --paper AKO26KnowledgeCollapse --paper-coverage-precheck`
...
|---|---|---|---|---|
| Observation 1 (Section 3.4, pp. 13–14, Observation 1 and displayed derivatives) | `observation1_public_complements_ai_substitutesSpec` -> `observation1_public_complements_ai_substitutes` | statement specification + proof stub | `PaperInterface.lean` | The transparent `...Spec : Prop` is the statement-audit target; the proof body is `by sorry`; raw-source-to-expanded-Spec judgment and premise provenance pending |
...
- [ ] Confirm `scripts/audit_conclusion_provenance.py --paper AKO26KnowledgeCollapse` reports
...
- [ ] Update `status.json`, then run `python3 scripts/sync_paper_status.py
      --paper AKO26KnowledgeCollapse`. Defer the unscoped aggregate/site sync to integration
      or release.
...
- [ ] After the report/DAG/status updates, run
      `python3 scripts/closeout_reuse_plan.py --paper AKO26KnowledgeCollapse`, follow its
